-- Phase 1.1: Fix SECURITY DEFINER search path vulnerability
-- All functions using SECURITY DEFINER need explicit search_path to prevent injection attacks
...
-- Fix create_fight_discussion_post
