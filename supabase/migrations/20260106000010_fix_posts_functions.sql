-- Fix posts functions - use correct column names

-- Fix get_posts_feed - use user_id from profiles and red_name/blue_name from bouts
DROP FUNCTION IF EXISTS get_posts_feed(INTEGER, INTEGER);
...
DROP FUNCTION IF EXISTS get_post_with_comments(UUID, INTEGER);
