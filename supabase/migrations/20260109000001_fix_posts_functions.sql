-- Fix posts functions to use correct table/column names
-- Fixes: profiles.id -> profiles.user_id, fighters -> ufc_fighters, display_name removal

-- Drop and recreate get_posts_feed
...
BEGIN
  ...
  SELECT
    ...
    pr.username AS author_display_name, -- Use username as display_name
...
-- Fix get_following_posts_feed_for_user
