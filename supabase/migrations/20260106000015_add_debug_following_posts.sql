-- Debug version of following posts that takes user_id as parameter
...
GRANT EXECUTE ON FUNCTION get_following_posts_feed_for_user(UUID, INTEGER, INTEGER) TO authenticated, anon, service_role;
