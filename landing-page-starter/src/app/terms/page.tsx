...
import { TERMS_OF_SERVICE } from '@/lib/copy'
import { Footer } from '@/components/Footer'

export const metadata = {
  title: 'Terms of Service - Upset',
  description: 'Terms of Service for the Upset fight picks tracking app',
}
      ...
      <main className="min-h-screen py-16 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          <article className="prose prose-invert prose-lg max-w-none">
            <h1 className="text-4xl font-bold mb-2">{TERMS_OF_SERVICE.title}</h1>
            <p className="text-gray-400 text-sm mb-8">{TERMS_OF_SERVICE.lastUpdated}</p>
